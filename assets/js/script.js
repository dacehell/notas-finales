...
var nota1HTML = parseInt(prompt("Ingrese la Nota 1 de HTML"));
var nota2HTML = parseInt(prompt("Ingrese la Nota 2 de HTML"));
var nota3HTML = parseInt(prompt("Ingrese la Nota 3 de HTML"));
